...
dados_escolas_final <- dados_escolas_final |>
  mutate(
    ...
    aprov_media = if_else(is.nan(aprov_media), NA_real_, aprov_media),
    reprov_media = if_else(is.nan(reprov_media), NA_real_, reprov_media),
    aband_media = if_else(is.nan(aband_media), NA_real_, aband_media),
    ideb_media = if_else(is.nan(ideb_media), NA_real_, ideb_media),
    portugues_media = if_else(is.nan(portugues_media), NA_real_, portugues_media),
    matematica_media = if_else(is.nan(matematica_media), NA_real_, matematica_media),
